namespace Edi.Converter.MessageType
{
  using System;
  ...
  [ValueConversion(typeof(ViewModel.Base.Msg.MsgCategory), typeof(System.Windows.Media.ImageSource))]
  public class MsgTypeToResourceConverter : IValueConverter
  {
    ...
    public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
    {
      ...
      if (!(value is ViewModel.Base.Msg.MsgCategory))
      ...
      switch ((ViewModel.Base.Msg.MsgCategory)value)
      {
