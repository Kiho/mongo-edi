namespace Edi.ViewModel.Base
{
  ...
  public class DialogViewModelBase : ViewModelBase
  {
    ...
    private ObservableCollection<EdiViews.Msg> mProblems;
    ...
    public DialogViewModelBase(DialogViewModelBase copyThis)
    {
      ...
      this.mProblems = new ObservableCollection<EdiViews.Msg>(copyThis.mProblems);
    ...
    /// <returns></returns>
    public delegate bool EvaluateInput(out List<EdiViews.Msg> outMsg);
    #endregion delegates
    ...
    public ObservableCollection<EdiViews.Msg> ListMessages
    {
      get
      {
        if (this.mProblems == null)
          this.mProblems = new ObservableCollection<EdiViews.Msg>();
    ...
    public void AddMessage(string strMessage, EdiViews.Msg.MsgCategory categoryOfMsg = EdiViews.Msg.MsgCategory.Error)
    {
      this.AddMessage(new EdiViews.Msg(strMessage, categoryOfMsg));
    }

    public void AddMessage(EdiViews.Msg inputMsg)
    {
      if (this.mProblems == null)
        this.mProblems = new ObservableCollection<EdiViews.Msg>();

      this.mProblems.Add(new EdiViews.Msg(inputMsg));
    }
    ...
    private void PerformInputDataEvaluation()
    {
      if (this.EvaluateInputData != null)
      {
        ...
        if (msgs != null)
        {
          foreach (EdiViews.Msg m in msgs)
          {
            if (m.CategoryOfMsg != EdiViews.Msg.MsgCategory.Information && m.CategoryOfMsg != EdiViews.Msg.MsgCategory.Warning)
              bFoundErrors = true;
