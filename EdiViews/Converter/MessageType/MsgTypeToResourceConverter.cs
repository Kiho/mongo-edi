namespace EdiViews.Converter.MessageType
{
  using System;
  ...
  [ValueConversion(typeof(EdiViews.Msg.MsgCategory), typeof(System.Windows.Media.ImageSource))]
  public class MsgTypeToResourceConverter : IValueConverter
  {
    ...
    public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
    {
      ...
      if (!(value is EdiViews.Msg.MsgCategory))
      ...
      switch ((EdiViews.Msg.MsgCategory)value)
      {
        case EdiViews.Msg.MsgCategory.Information:
          break;
        case EdiViews.Msg.MsgCategory.Error:
          resourceUri = "Images/MessageIcons/Error.png";
          break;
        case EdiViews.Msg.MsgCategory.Warning:
          resourceUri = "Images/MessageIcons/Warning.png";
          break;
        case EdiViews.Msg.MsgCategory.InternalError:
          resourceUri = "Images/MessageIcons/InternalError.png";
          break;
        case EdiViews.Msg.MsgCategory.Unknown:
        default:
